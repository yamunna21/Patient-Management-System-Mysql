...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			$search_query .= 'OR patient_degree LIKE "%'.$_POST["search"]["value"].'%" ';
			$search_query .= 'OR patient_expert_in LIKE "%'.$_POST["search"]["value"].'%" ';
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = $row["patient_expert_in"];
			$status = '';
	...
	if($_POST["action"] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			...
			$data['patient_degree'] = $row['patient_degree'];
			$data['patient_expert_in'] = $row['patient_expert_in'];
		}
